...
if M == 2
    ...
    plot3(cost_MOGSK(:, 1), cost_MOGSK(:, 2), 'x', 'MarkerEdgeColor', '#D95319'); hold on;
    plot(cost_MOGWEO(:, 1), cost_MOGWEO(:, 2), 'p', 'MarkerEdgeColor', '#EDB120');
    legend({'MOGWO', 'MOEO', 'MOGSK', 'MOGWEO'}, 'FontName', 'Times New Roman', ...
        'FontSize', 14);
...
elseif M == 3
    ...
    plot3(cost_MOGSK(:, 1), cost_MOGSK(:, 2), cost_MOGSK(:, 3), 'x', ...
        'MarkerEdgeColor', '#D95319'); hold on;
    plot3(cost_MOGWEO(:, 1), cost_MOGWEO(:, 2), cost_MOGWEO(:, 3), 'p', ...
        'MarkerEdgeColor', '#EDB120');
    ax.FontName = 'Times New Roman';
    ax.FontSize = 16;
    legend({'MOGWO', 'MOEO', 'MOGSK', 'MOGWEO'}, 'FontName', 'Times New Roman', ...
        'FontSize', 14, 'Position', [0.15, 0.57, 0.27, 0.19]);
    xlabel('{\it{F_{loss}}} (kW)', 'FontName', 'Times New Roman', 'FontSize', 16, ...
